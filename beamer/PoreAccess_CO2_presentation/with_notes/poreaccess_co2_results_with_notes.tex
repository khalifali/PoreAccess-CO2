...
\begin{frame}{The homogeneous 1D uptake model}
  \begin{columns}[T,onlytextwidth]
    \column{0.55\textwidth}
      ...
      \]
      \begin{itemize}
        \item Solve both equations together for $c(z,t)$ and $q(z,t)$.
        \item Use 100 cells and prescribed initial and boundary conditions.
      \end{itemize}
    \column{0.41\textwidth}
      ...
      \small
      \begin{itemize}
        \item Match the network's bed height, porosity and inlet condition.
        \item Use the same Langmuir parameters, LDF coefficient and initial state.
        \item Only $D$ changes during fitting.
      \end{itemize}
  \end{columns}
  \vspace{0.18cm}
