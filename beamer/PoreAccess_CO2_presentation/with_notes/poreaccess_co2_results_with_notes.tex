...
\begin{frame}{Twenty beds isolate variability caused by random arrangement}
  \begin{FlexRow}{0.57\textheight}
    \Col{0.43}{
      ...
      inlet $c_{\rm CO_2}$ & 6.05 mol m$^{-3}$\textsuperscript{*}\\
  ...
  \vspace*{0.5cm}
  {\scriptsize\textsuperscript{*}Approximately 15 vol.\% CO$_2$ at atmospheric pressure and 298 K.}\par
...
\begin{frame}{Langmuir equilibrium and bead uptake}
  \begin{columns}[T,onlytextwidth]
    \column{0.52\textwidth}
      ...
      \footnotesize
      \begin{itemize}\setlength{\itemsep}{1pt}\setlength{\parskip}{0pt}
        \item $q_s$: maximum CO$_2$ loading [mol/kg adsorbent]
        \item $b$: Langmuir affinity [Pa$^{-1}$], with $b p_k$ dimensionless
        \item $p_k$: local CO$_2$ partial pressure [Pa]
        \item $q_k^*$: equilibrium loading at $p_k$
      \end{itemize}
    \column{0.44\textwidth}
      ...
      \end{itemize}
  \end{columns}
  \result{Coupled diffusion and adsorption conserve the CO$_2$ inventory.}
  \note{
...
\end{frame}
\appendix
\section[Backup]{Backup: pore-network construction}
\begin{frame}{}
\vfill
{\large\color{tumgray}Backup slides}\par\vspace{0.4cm}
