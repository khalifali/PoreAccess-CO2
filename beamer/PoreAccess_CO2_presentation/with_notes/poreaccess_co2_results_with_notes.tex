...
\begin{frame}{Twenty beds isolate variability caused by random arrangement}
  \begin{columns}[T,onlytextwidth]
    ...
    \item same beads and tube; only the insertion seed changes
    \item dry, isothermal gas supplied from below
    \item diffusion and adsorption, with no imposed flow
    \item heat effects and competitive water adsorption excluded
    \end{itemize}
  \end{columns}
  \vspace{0.20cm}
  {\footnotesize $c_{\rm in}=y_{\rm CO_2}p/(RT)\approx6.05$ mol m$^{-3}$ at 15 vol.\%, 1 bar and 298 K.\par
  15\% represents coal-combustion flue gas (typical CO$_2$: 10--15\%).\par
  A dry, cooled reference gas fixes the driving concentration across all beds.}\par
  {\scriptsize\href{https://www.energy.gov/sites/default/files/2016/01/f28/QTR2015-4E-Carbon-Dioxide-Capture-Technologies.pdf}{Source: U.S. DOE, Quadrennial Technology Review (2015), Sec. 4.E.}}\par
  \vspace{0.15cm}
  \result{The ensemble tests arrangement effects under otherwise identical conditions.}
\note{The inlet value corresponds to a CO2 mole fraction of approximately 15 percent at one bar: c equals y times p divided by RT. The DOE report gives a typical coal-combustion flue-gas range of 10 to 15 percent CO2, which motivates this representative concentration. Temperature is held at 298.15 K and the gas is dry, so this is a cooled, simplified reference condition. We do not simulate hot, wet industrial flue gas or its other constituents. Keeping the same reservoir concentration for all twenty beds isolates arrangement effects. The cited concentration range motivates the boundary condition, not a claim of industrial process validation.}
\end{frame}
...
\]
The time weights account for unequal spacing of saved outputs.
\end{columns}
\vspace{0.2cm}
\result{A fitted $D_{\rm eff}$ is a reduction target for each bed, not yet a geometry-based prediction.}
